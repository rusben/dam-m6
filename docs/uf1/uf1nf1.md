...
# Exemples: Llegir informació introduïda per l'usuari <a name="exemples-lectura-informacio"></a>
...
# La classe File de Java <a name="classe-file-java"></a>
...
# Exemples d'ús de la classe File de Java <a name="exemples-classe-file-java"></a>
...
# Exercicis <a name="exercicis-classe-file-java"></a>
## Exercici 1
